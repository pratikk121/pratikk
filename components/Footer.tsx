    ...
    return (
        <footer>
            ...
            <div style={{ display: 'flex', gap: '1.5rem', justifyContent: 'center', marginTop: '1rem' }}>
                ...
                <a href="https://www.linkedin.com/in/pratik-kadole-119391267/" aria-label="LinkedIn Profile" style={{ color: 'var(--text-secondary)', fontSize: '1.2rem' }}><i className="ri-linkedin-line"></i></a>
            </div>
        </footer>
    );
}
